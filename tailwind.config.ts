  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'stat-bounce': 'stat-bounce 0.6s ease-in-out',
        'step-pulse': 'step-pulse 3s ease-in-out infinite',
        'line-draw': 'line-draw 1.5s ease-out forwards',
        'icon-rotate': 'icon-rotate 4s ease-in-out infinite',
      ...
      keyframes: {
        ...
        'step-pulse': {
          '0%, 100%': { 
            transform: 'scale(1)',
            'box-shadow': '0 10px 25px -12px rgba(79, 70, 229, 0.25)'
          },
          '50%': { 
